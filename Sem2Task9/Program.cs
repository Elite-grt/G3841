...
// int rndNum = numSintezater.Next(10,100);
...
// Вариант  2
// Char - переменная сылочного типа. ToString()- превращение числа в строку, а затем ToCharArray() - разделелние числа в символы
// Char[] digits = numSintezater.Next(10,100).ToString().ToCharArray();
// Console.WriteLine(digits);
// // Преобразуем символ в число ((int)digits[0]-48)
