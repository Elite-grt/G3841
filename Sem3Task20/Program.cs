...
{
    double res = 0;
    res = Math.Sqrt(Math.Pow(x1 - x2, 2) + Math.Pow(y1 - y2, 2));  // Возведение в корень
    return res;
}
...
//     ReadData("Ввидите координату x1"),
//     ReadData("Ввидите координату x2"),
//     ReadData("Ввидите координату y1"),
//     ReadData("Ввидите координату y2")));
